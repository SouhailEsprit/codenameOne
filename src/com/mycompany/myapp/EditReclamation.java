 ...
 * @author louay
 */
public class EditReclamation extends SideMenuBaseForm {

    public EditReclamation(Resources res, reclamation publication) {
        super(BoxLayout.y());
        ...
        TextField message = new TextField(publication.getMessage(), "Nom ...");
        ...
        addPub.addActionListener(l -> {
            if (message.getText().equals("")) {
                ...
                publication.setMessage(message.getText());

                reclamationService.getInstance().edit(publication);
                iDialog.dispose();
