 ...
 * @author louay
 */
public class EditType extends SideMenuBaseForm {

    public EditType(Resources res, typeExercice publication) {
        super(BoxLayout.y());
        ...
        Container titleCmp = BoxLayout.encloseY(
                ...
                BorderLayout.centerAbsolute(
                        BoxLayout.encloseY(
                                new Label("Edit Type exercice", "Title")
                        )
                )
        );
        ...
        addPub.addActionListener(l -> {
            if (titre.getText().equals("")) {
                ...
                typeExerciceService.getInstance().editType(publication);
                iDialog.dispose();
